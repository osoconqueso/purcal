...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'service.accounttype' => 'getService_AccounttypeService',
            'service.calculator' => 'getService_CalculatorService',
            'service.model' => 'getService_ModelService',
            'service.risktolerance' => 'getService_RisktoleranceService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('iU8rFeOF0T', '', (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('--d4nbIkD-', '', 'nKW5sEAfvHa3RIPMTMsEPg', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qnlJLntDFS', '', 'nKW5sEAfvHa3RIPMTMsEPg', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cDqo1lxW5e', '', 'nKW5sEAfvHa3RIPMTMsEPg', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'purcal', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_681baf3863fea1867478620adde5ff9b3e2daa1aa8b97230cee8ce733b5b5290');
    ...
    /**
     * Gets the 'service.accounttype' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\AccountTypeService A AppBundle\Service\AccountTypeService instance
     */
    protected function getService_AccounttypeService()
    {
        return $this->services['service.accounttype'] = new \AppBundle\Service\AccountTypeService($this->get('doctrine'));
    }

    /**
     * Gets the 'service.calculator' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getService_CalculatorService()
    {
        return $this->services['service.calculator'] = new \AppBundle\Service\CalculatorService($this->get('doctrine'));
    }

    /**
     * Gets the 'service.model' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\ModelService A AppBundle\Service\ModelService instance
     */
    protected function getService_ModelService()
    {
        return $this->services['service.model'] = new \AppBundle\Service\ModelService($this->get('doctrine'));
    }

    /**
     * Gets the 'service.risktolerance' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Service\RiskToleranceService A AppBundle\Service\RiskToleranceService instance
     */
    protected function getService_RisktoleranceService()
    {
        return $this->services['service.risktolerance'] = new \AppBundle\Service\RiskToleranceService($this->get('doctrine'));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('WhateverSomeStupidShit');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57b0ebf06ee814.90048103')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'WhateverSomeStupidShit',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'WhateverSomeStupidShit',
